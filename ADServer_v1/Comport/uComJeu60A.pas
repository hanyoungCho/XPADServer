...
begin
  ...
  begin
    Global.Log.LogCtrlWriteA6001(FIndex, '요청타석기: ' + IntToStr(Global.Teebox.GetDevicToFloorTeeboxNo(FFloor, FChannel)) + ' / 총글자수: ' + IntToStr(Count) + ' / ' + FRecvData);
    FRecvData := '';
    Exit;
  end;
  ...
  begin
    ...
    begin
      ...
      rSeatInfo.ErrorCd := 0;
      rSeatInfo.ErrorCd2 := '0';

      rSeatInfo.ErrorCd := 10 + StrToInt( copy(FRecvData, 14, 1) );
      rSeatInfo.ErrorCd2 := copy(FRecvData, 14, 1);
