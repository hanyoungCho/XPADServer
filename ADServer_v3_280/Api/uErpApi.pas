...
begin
  ...
  try
    ...
    begin
      ...
      Global.Log.LogBeamCtrlWrite('w:' + sSendData);

      IOHandler.ReadBytes(Buf, 1, False);
      SetString(strAnsi, PAnsiChar(@Buf[0]), 1);
      Global.Log.LogBeamCtrlWrite('R:' + IntToHex(Buf[0]));
    end;
...
begin
  ...
  try
    ...
    try
      ...
      on E: exception do
      begin
        Global.Log.LogBeamCtrlWrite('Connect exception:' + E.Message);
        Exit;
      end;
    end;
    ...
    begin
      ...
      if iReadSize > 0 then begin
         ...
         Global.Log.LogBeamCtrlWrite('R:' + strAnsi);
    ...
    begin
      try
        ...
        on E: exception do
        begin
          Global.Log.LogBeamCtrlWrite('WriteLn exception:' + E.Message);
          Exit;
        end;
      end;
