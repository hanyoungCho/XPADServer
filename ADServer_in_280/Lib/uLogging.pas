...
type
  ...
  private
    ...
    FLogTcpAgentServerExceptionFileName: String;
  ...
  public
    ...
    procedure LogAgentServerException(ALog: string);
...
begin
  ...
  FLogCtrlFileName := FLogDir + 'ADCtrl_';
  ...
  FLogTcpAgentServerFileName := FLogDir + 'AgentServer_';
  FLogTcpAgentServerReadFileName := FLogDir + 'AgentServerRead_';
  FLogTcpAgentServerEventFileName := FLogDir + 'AgentServerEvent_';
  FLogTcpAgentServerExceptionFileName := FLogDir + 'AgentServerException_';
...
procedure TLog.LogAgentServerException(ALog: string);
begin
  WriteLogDayFile(FLogTcpAgentServerExceptionFileName, ALog);
end;
